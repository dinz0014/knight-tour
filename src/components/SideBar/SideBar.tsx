	...
	return (
		<Stack className={classes.root}>
			...
			<List className={classes.instructions} type="ordered">
				<List.Item>Click "START" and provide a starting square for the Knight</List.Item>
				<List.Item>
					You can move your Knight by first clicking on the square that the Knight is at,
					and then selecting another square for the Knight to move to.
				</List.Item>
				...
				<List.Item>
					The game ends when you either visit all the squares or the Knight runs out of
					valid moves.
				</List.Item>
			</List>
			<ButtonBar />
